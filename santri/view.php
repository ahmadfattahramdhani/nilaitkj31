                        ...
                        if (mysqli_num_rows($result)) {
                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                ...
                                <td>
                                    ...
                                    <a href="?m=santri&s=delete&id='.$r['ids'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin Jurusan Akan Dihapus?, Menghapus Jurusan Akan Menghilangakn semua data santri pada Jurusan Tersebut\')">Hapus</a>
                                </td>
                            </tr>';
                            $no++;
                        }
