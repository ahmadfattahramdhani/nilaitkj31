    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header row">
                <div class="card-title h3 col-8"> Edit Nama Mapel</div>
                <div class="col-4">
           ...
           <?php 
            ...
            <div class="card-body">
                <form action="?m=mapel&s=update" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" name="hours"  value="<?=$r['hours']?>" class="form-control" placeholder="Waktu Belajar" required autofocus>
                    </div>
                    <div class="mb-3">
